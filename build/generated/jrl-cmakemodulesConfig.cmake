...
set("jrl-cmakemodules_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("JRL_CMAKEMODULES_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("jrl-cmakemodules_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/jrl-cmakemodules/doxygen-html")
set("JRL_CMAKEMODULES_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/jrl-cmakemodules/doxygen-html")
set("jrl-cmakemodules_DEPENDENCIES" "")
set("jrl-cmakemodules_PKG_CONFIG_DEPENDENCIES" "")
...
set("_jrl-cmakemodules_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST" "")
if(_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _jrl-cmakemodules_PKG_CONFIG_LIBS_LIST "${_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _jrl-cmakemodules_PKG_CONFIG_LIBS_LIST "${_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_jrl-cmakemodules_PKG_CONFIG_LIBDIR})
  foreach(component ${_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_jrl-cmakemodules_PKG_CONFIG_LIBS_LIST)

set("jrl-cmakemodules_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("JRL_CMAKEMODULES_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${jrl-cmakemodules_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/jrl-cmakemodulesTargets.cmake")
...
foreach(component ${jrl-cmakemodules_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(jrl-cmakemodules_${component}_FOUND FALSE)
  endif()
  if(jrl-cmakemodules_${component}_FOUND)
    message(STATUS "jrl-cmakemodules: ${component} found.")
  else()
    if(jrl-cmakemodules_FIND_REQUIRED_${component})
      message(FATAL_ERROR "jrl-cmakemodules: ${component} not found.")
    else()
      message(STATUS "jrl-cmakemodules: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("jrl-cmakemodules")
