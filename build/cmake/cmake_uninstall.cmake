...
IF(NOT EXISTS "/home/ravi/spacewalk/kepler/jrl-cmakemodules/build/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/home/ravi/spacewalk/kepler/jrl-cmakemodules/build/install_manifest.txt")

MESSAGE(STATUS "catkin path: /opt/gravity/.catkin")
IF(EXISTS "/opt/gravity/.catkin" AND PACKAGE_CREATES_DOT_CATKIN)
  MESSAGE(STATUS "Try to remove /opt/gravity/.catkin")
  EXECUTE_PROCESS(
      COMMAND ${CMAKE_COMMAND} -E remove "/opt/gravity/.catkin"
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/home/ravi/spacewalk/kepler/jrl-cmakemodules/build/install_manifest.txt" files)
STRING(REPLACE "\n" ";" files "${files}")
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND ${CMAKE_COMMAND} -E remove "/home/ravi/spacewalk/kepler/jrl-cmakemodules/build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
